...
export default function App() {
  ...
  <Fragment>
    <View >
    <Text style={{fontSize:40,color:'#37BC90',marginTop:20,marginLeft:20, fontWeight: 'bold'}}>Add Patient</Text>
     
    </View>

    <View style={styles.add}>
     <TextInput  placeholder="Patient mail id" style={styles.screen}/>
